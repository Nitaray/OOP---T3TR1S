...
public class QuitToMainMenuButton extends Button {
     ...
     */
    public QuitToMainMenuButton(Vector3f topLeft, float width, float height, String shaderName, String normalTextureName, String selectedTextureName, ShaderManager shaderManager, boolean initialSelection) {
